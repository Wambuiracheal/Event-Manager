                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="id-number" type="id-number" class="form-control @error('id-number') is-invalid @enderror" name="id-number" required autocomplete="new-id-number">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="phone-number" type="phone-number" class="form-control @error('phone-number') is-invalid @enderror" name="id-number" required autocomplete="new-phone-number">
